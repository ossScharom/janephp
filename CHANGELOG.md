...
### Fixed
- [JsonSchema] [GH#1048](https://github.com/janephp/janephp/pull/1048) Deduplicate phpDoc type hints when several `anyOf` / `oneOf` branches resolve to the same PHP type (no more `string|string` in generated docblocks)
